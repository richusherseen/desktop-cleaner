extension_paths = {
        ...
        '.log':    'programming/essential files',
        '.mdb':    'programming/database',
        '.sav':    'programming/database',
        '.sql':    'programming/database',
        '.sqlite3':'programming/database',
        '.dump':   'programming/database',
        '.tar':    'programming/database',
        '.xml':    'programming/essential files',
        '.json':   'programming/essential files',
        '.css':    'programming/web',
        '.htm':    'programming/web',
        '.js':     'programming/web',
        '.xhtml':  'programming/web',
